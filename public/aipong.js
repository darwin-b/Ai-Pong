...
async function init(){
    ...
    model =  await tf.loadModel('https://raw.githubusercontent.com/TejasReddy9/ai-pong/master/tfjsmodel/model.json');
    // model =  await tf.loadModel('tfjsversion/model.json');
    console.log('model loaded from storage');
    computer.ai_plays = true;

     if(computer.ai_plays){
        document.getElementById("playing").innerHTML = "Playing top: AI";
    }else{
        document.getElementById("playing").innerHTML = "Playing top: Computer";
    }
